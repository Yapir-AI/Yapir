...
import { noteTemplateGetOperation } from "#api/lib/note-templates/note-template-get.operation";
import { noteTemplateListOperation } from "#api/lib/note-templates/note-template-list.operation";
import { noteTemplateUpdateOperation } from "#api/lib/note-templates/note-template-update.operation";
import { gitConnectorListOperation } from "#api/lib/git-connectors/git-connector-list.operation";
import { githubConnectorInstallationCallbackOperation } from "#api/lib/git-connectors/github/github-connector-installation-callback.operation";
import { githubConnectorInstallationStartOperation } from "#api/lib/git-connectors/github/github-connector-installation-start.operation";
