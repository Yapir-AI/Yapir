...
Every CommentSet records the ChangeRequest commit current at submission. It becomes old when the ChangeRequest head advances, while its threads remain usable. Oldness and resolution are independent: an old thread may remain open, and a resolved thread may later become old.
